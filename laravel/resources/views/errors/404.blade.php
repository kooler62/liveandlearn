...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <style>
        ...
        .wthree_social_icons a:nth-of-type(1):before {
            content:'';
            background:url(/img/img-sp.png) no-repeat 13px 11px;
            display:block;
            width:40px;
            height:40px;
        }
        ...
        .wthree_social_icons a:nth-of-type(2):before {
            content:'';
            background:url(/img/img-sp.png) no-repeat -18px 11px;
            display:block;
            width:40px;
            height:40px;
        }
        ...
        .wthree_social_icons a:nth-of-type(3):before {
            content:'';
            background:url(/img/img-sp.png) no-repeat -53px 11px;
            display:block;
            width:40px;
            height:40px;
        }
        ...
        .wthree_social_icons a:nth-of-type(4):before {
            content:'';
            background:url(/img/img-sp.png) no-repeat -89px 11px;
            display:block;
            width:40px;
            height:40px;
        }
        ...
        .wthree_social_icons a:nth-of-type(5):before {
            /*-- w3layouts --*/
            content:'';
            background:url(/img/img-sp.png) no-repeat -122px 11px;
            display:block;
            width:40px;
            height:40px;
        }
...
<div class="main">
    <div class="nav_w3l">
        <ul>
            ...
            <li><a href="/categories/parables" class="hvr-sweep-to-bottom">Притчі</a></li>
            <li><a href="/categories/stories" class="hvr-sweep-to-bottom">Історії</a></li>
            <li><a href="/categories/advices" class="hvr-sweep-to-bottom">Поради</a></li>
            <li><a href="/excerptions" class="hvr-sweep-to-bottom">Цитати</a></li>
        </ul>
    </div>
    <h1>404</h1>
